...
class RWBYOreGeneration extends IWorldGenerator {
    ...
    override def generate(rand: Random, x: Int, z: Int, world: World, iChunkGenerator: IChunkGenerator, iChunkProvider: IChunkProvider): Unit = {
        ...
        generateOre(RWBYBlocks.earthDustOre, world, rand, x, z, 2, 8, 8, 5, 68)
        generateOre(RWBYBlocks.fireDustOre, world, rand, x, z, 2, 8, 8, 5, 68)
        generateOre(RWBYBlocks.waterDustOre, world, rand, x, z, 2, 8, 8, 5, 68)
    }
